...
I am also trying to put a [WebGL version](https://automaticcomputer.github.io/SiriusOnUnity/SiriusOnUnity_WebGL/index.html), 
but it seems that this is not working yet. 
